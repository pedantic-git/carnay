...
class StationsControllerTest < ActionController::TestCase
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post :create, station: { code: @station.code, gmaps: @station.gmaps, latitude: @station.latitude, longitude: @station.longitude, name: @station.name }
    end
  ...
  test "should update station" do
    patch :update, id: @station, station: { code: @station.code, gmaps: @station.gmaps, latitude: @station.latitude, longitude: @station.longitude, name: @station.name }
    assert_redirected_to station_path(assigns(:station))
  end
